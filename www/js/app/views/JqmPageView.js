define([
    ...
    var View = Backbone.View.extend({
		...
		setPanelView: function(view) {
            this.panelView = view;
			console.log("Vieeeeww");
            return this;
        },
		
		setRightPanelView: function(view) {
            this.rightPanelView = view;
			console.log("Vieeeeww that to right one!!!");
            return this;
        },
        ...
        render: function() {
			...
			if (this.panelView) {
                this.$('[data-role="panel"]').html(this.panelView.render().$el);
				console.log(this.panelView.render().$el);
				console.log(this.panelView.render().$el);
            }
			if (this.rightPanelView) {
                this.$('[id="right-panel"]').html(this.rightPanelView.render().$el);
				console.log(this.rightPanelView.render().$el);
				console.log(this.rightPanelView.render().$el);
            }
            if (this.footerView) {
